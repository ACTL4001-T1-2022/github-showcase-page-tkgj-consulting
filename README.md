...
The team selection includes nine non-Raritan players, which may be a concern to stakeholders. Unselected Raritan football players may find it unfair that international players were chosen in their place; while citizens from the countries of the international players will find it unfair that their players are being taken at the expense of a 10% loan fee. It is also arguable that such a strategy affects the integrity of the Raritan football brand since it is partially built on non-native players. However, choosing international players is necessary for the establishment of football in Rarita and is a short-term solution for the lack of popularity and wellbeing of Raritan players. Additionally, the practice of players switching national allegiances is not uncommon and so the course of action would be to properly recognise the loaned players as part of the team to ease concerns and focus on the development of Raritan football.

Another potential issue is that the team was chosen entirely using the player data from the 2020 and 2021 seasons, which may be a demeaning approach from the players’ perspective. The objective nature of this may be cut-throat as players do not get a chance to justify their selection outside of their data, which may not fully capture their value to the team. While metrics such as popularity and wellbeing were also considered, players may argue that the usage of factors such as national social media following is unfair as they have little control over them. The future team selection process should factor in human judgement, perhaps from an experienced coach, as players will feel content when the selections can be justified by both objective and subjective evidence.
